...
Entrega: ¿solo Necochea? ¿hay radio fijo? ¿costo por zona?

Horarios: ¿permiten programar pedidos?

Pagos: ¿arrancan con efectivo/transferencia? ¿quieren MercadoPago sí o sí?

Pedido mínimo: ¿hay mínimo para envío?

Helados: ¿requiere logística especial? (tiempo máximo, franja horaria)

Comidas: ¿menú cambia por día? (muy común)

Mayorista: ¿es “pedido recurrente” a negocios? ¿requiere aprobación?

Datos del cliente: ¿piden dirección exacta + referencias + teléfono?

Impresión/Comanda: ¿quieren ticket en cocina o con ver en pantalla alcanza?

El software viejo (DataLife): ¿qué hace exactamente y por qué no lo usan? (si no es core, no tocarlo)
...
Un cliente puede completar un pedido con retiro o envío y recibe confirmación con ID.

El admin ve el pedido en “Nuevo” y puede pasarlo por estados hasta “Cerrado” o “Cancelado”.

El admin puede pausar pedidos y editar productos (precio/habilitado).

Si el local está cerrado, el checkout no permite confirmar pedido (mensaje claro).
